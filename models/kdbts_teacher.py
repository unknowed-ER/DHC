...
@add_argument("--test_prior", type=str2bool, default=True)     # always true
@add_argument("--stop_gradient", type=str2bool, default=False)       # not used
class SKT_fixteacher(BaseModel):
    def __init__(self,
                 hparams,
                 vocabulary):
        super().__init__(hparams, vocabulary, "SKT_fixteacher")
