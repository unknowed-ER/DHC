...
@add_argument("--stop_gradient", type=str2bool, default=True)       # not use
class PIPM_student(BaseModel):
    def __init__(self,
                 hparams,
                 vocabulary):
        super().__init__(hparams, vocabulary, "PIPM_student")
    ...
    def call(self, inputs, training: bool = True):
        ...
        if training:
            ...
            _, pred_info = tf.math.top_k(pred_logits, k=20)
            pred_info = self.vocabulary.index_to_string(pred_info)            
